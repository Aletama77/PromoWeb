...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <main>
       <div class="d-flex flex-column gap-3 align-items-center h-100 justify-content-center mt-5">
           ...
           <asp:TextBox ID="voucherTextBox" placeholder="X-X-X-X-X-X" runat="server" class="text-center p-1 fs-1" />
           <asp:Button ID="reclamarVoucherButton" Text="Probar suerte" class="mt-5 btn-success fs-4 p-1" runat="server"  /> 
       </div>
    </main>
</asp:Content>
